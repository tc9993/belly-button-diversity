...
function buildCharts(sample) {
  ...
  d3.json("static/js/samples.json").then((data) => {
    ...
    var metaFiltered = meta.filter(sampleObj => sampleObj.id == sample);
    var metaResult = metaFiltered[0];
    ...
    var yIDs = otu_ids.slice(0,10).reverse();
    var yOtu = yIDs.map(x => 'OTU ' + x);
    var yticks = yOtu;
    console.log(yticks);
    ...
    var barLayout = {
     title: 'Top 10 Living Things in this Belly Button'
    };
